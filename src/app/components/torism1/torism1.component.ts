...
@Component({
  selector: 'app-torism1',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './torism1.component.html',
  styleUrl: './torism1.component.css'
})
export class Torism1Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
  openGoogleMaps() {
