...
@Component({
  selector: 'app-cairo36',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo36.component.html',
  styleUrl: './cairo36.component.css'
})
export class Cairo36Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
