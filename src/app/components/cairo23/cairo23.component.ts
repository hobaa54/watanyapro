...
@Component({
  selector: 'app-cairo23',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo23.component.html',
  styleUrl: './cairo23.component.css'
})
export class Cairo23Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
