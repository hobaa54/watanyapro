...
@Component({
  selector: 'app-october4',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './october4.component.html',
  styleUrl: './october4.component.css'
})
export class October4Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
