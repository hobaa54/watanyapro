...
export class MarketComponent {
  ...
  backLink = computed(() => {
    ...
    if (id === 'Cairo36') return '/app-cairo36';   // عدّلها حسب route بتاع Cairo35
    if (id === 'Cairo37') return '/app-cairo37';   // عدّلها حسب route بتاع Cairo35
    if (id === 'Cairo38') return '/app-cairo38';   // عدّلها حسب route بتاع Cairo35
    ...
    if (id === 'Gharbia1') return '/app-gharbia1';  // عدّلها حسب route بتاع Isamilia2
