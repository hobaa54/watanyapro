...
@Component({
  selector: 'app-behera1',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './behera1.component.html',
  styleUrl: './behera1.component.css'
})
export class Behera1Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
