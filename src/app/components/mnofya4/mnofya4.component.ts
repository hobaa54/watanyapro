...
@Component({
  selector: 'app-mnofya4',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './mnofya4.component.html',
  styleUrl: './mnofya4.component.css'
})
export class Mnofya4Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
...
export const SERVICES2 = [
...

  {
    ...
    route: '/market/Mnofya4'
  },
  {
    title: 'كوفي شوب',
    icon: 'bi bi-cup-hot-fill',
    route: '/coffee/Mnofya4'
  },
];
