...
@Component({
  selector: 'app-mnofya3',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './mnofya3.component.html',
  styleUrl: './mnofya3.component.css'
})
export class Mnofya3Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
