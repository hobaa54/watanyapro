...
@Component({
  selector: 'app-cairo32',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo32.component.html',
  styleUrl: './cairo32.component.css'
})
export class Cairo32Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
