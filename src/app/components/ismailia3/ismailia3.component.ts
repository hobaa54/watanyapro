...
@Component({
  selector: 'app-ismailia3',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './ismailia3.component.html',
  styleUrl: './ismailia3.component.css'
})
export class Ismailia3Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
...
export const SERVICES2 = [
  ...
  },
  {
    ...
    route: '/cars/Ismailia3'
  },

  {
    title: 'محلات اضافيه',
    icon: 'fa-solid fa-table-tennis-paddle-ball',
    route: '/shops/Ismailia3'
  },
