...
@Component({
  selector: 'app-cairo15',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo15.component.html',
  styleUrl: './cairo15.component.css'
})
export class Cairo15Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
