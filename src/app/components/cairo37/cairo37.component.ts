...
@Component({
  selector: 'app-cairo37',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo37.component.html',
  styleUrl: './cairo37.component.css'
})
export class Cairo37Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
