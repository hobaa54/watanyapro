...
@Component({
  selector: 'app-cairo33',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo33.component.html',
  styleUrl: './cairo33.component.css'
})
export class Cairo33Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
