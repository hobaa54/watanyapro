...
@Component({
  selector: 'app-qalyub7',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './qalyub7.component.html',
  styleUrl: './qalyub7.component.css'
})
export class Qalyub7Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
