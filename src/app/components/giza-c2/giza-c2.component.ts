...
@Component({
  selector: 'app-giza-c2',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './giza-c2.component.html',
  styleUrl: './giza-c2.component.css'
})
export class GizaC2Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
