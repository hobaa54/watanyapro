...
@Component({
  selector: 'app-alamin2',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './alamin2.component.html',
  styleUrl: './alamin2.component.css'
})
export class Alamin2Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
