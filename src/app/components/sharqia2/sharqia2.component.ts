...
@Component({
  selector: 'app-sharqia2',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './sharqia2.component.html',
  styleUrl: './sharqia2.component.css'
})
export class Sharqia2Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
