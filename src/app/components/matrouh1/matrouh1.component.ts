...
@Component({
  selector: 'app-matrouh1',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './matrouh1.component.html',
  styleUrl: './matrouh1.component.css'
})
export class Matrouh1Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
