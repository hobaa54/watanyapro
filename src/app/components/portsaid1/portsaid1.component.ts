...
@Component({
  selector: 'app-portsaid1',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './portsaid1.component.html',
  styleUrl: './portsaid1.component.css'
})
export class Portsaid1Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
