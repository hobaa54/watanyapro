...
@Component({
  selector: 'app-cairo11',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo11.component.html',
  styleUrl: './cairo11.component.css'
})
export class Cairo11Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
  openGoogleMaps() {
...
export const SERVICES2 = [
...

  {
    ...
    route: '/market/Cairo11'
  },
  {
    title: 'مطاعم',
    icon: 'bi bi-shop-window',
    route: '/restaurant/Cairo11'
  },
];
