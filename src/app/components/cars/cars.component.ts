...
type StationId = 'rehab' | 'madinty' | 'tirumph' | 'tagamo35' | 'AUC' | 'forest' | 'Master' | 'Master2' |
  ...
  | 'Mnofya2' | 'Mnofya3' | 'Sharm' | 'Alex1' | 'Alex2' | 'Alex3' | 'Alex4' | 'Alex5'
  | 'Ismailia1' | 'Ismailia2' | 'Ismailia3' | 'Gharbia1' | 'Gharbia2' | 'Sharqia1' | 'Sharqia2' | 'Aswan1' | 'Aswan2'
  | 'Matrouh1' | 'Matrouh2' | 'Matrouh3' | 'Cairo36' | 'Cairo37' | 'Cairo38' | 'North' | 'Asuot1'
  | 'Asuot2' | 'Asuot3' | 'Dakahlia1' | 'Behera1' | 'Portsaid1' | 'Kafr1' | 'Sohag1' | 'Mnofya4'; // أضف باقي الـ stationIds هنا
...
export class CarsComponent {
  ...
  backLink = computed(() => {
    ...
    if (id === 'Asuot2') return '/app-asuot2';  // عدّلها حسب route بتاع Asuot2
    if (id === 'Asuot3') return '/app-asuot3';  // عدّلها حسب route بتاع Asuot3
    ...
    if (id === 'Portsaid1') return '/app-portsaid1';     // عدّلها حسب route بتاع Portsaid1
    if (id === 'Kafr1') return '/app-kafr1';     // عدّلها حسب route بتاع Kafr1
    if (id === 'Sohag1') return '/app-sohag1';     // عدّلها حسب route بتاع Sohag1
  ...
  constructor(private route: ActivatedRoute) {
    this.route.paramMap.subscribe(pm => {
      ...
      if (id === 'rehab' || id === 'madinty' || id === 'tirumph' || id === 'tagamo35' || id === 'AUC' || id === 'forest'
        ...
        || id === 'Sharm' || id === 'Alex1' || id === 'Alex2' || id === 'Alex3' || id === 'Alex4' || id === 'Alex5'
        || id === 'Ismailia1' || id === 'Ismailia2' || id === 'Ismailia3' || id === 'Gharbia1' || id === 'Gharbia2' || id === 'Sharqia1' || id === 'Sharqia2'
        || id === 'Aswan1' || id === 'Aswan2' || id === 'Matrouh1' || id === 'Matrouh2' || id === 'Matrouh3'
        || id === 'Cairo36' || id === 'Cairo37' || id === 'Cairo38' || id === 'North' || id === 'Asuot1' || id === 'Asuot2' || id === 'Asuot3'
        || id === 'Dakahlia1' || id === 'Behera1' || id === 'Portsaid1' || id === 'Kafr1' || id === 'Sohag1' || id === 'Mnofya4'
