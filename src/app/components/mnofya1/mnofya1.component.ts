...
@Component({
  selector: 'app-mnofya1',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './mnofya1.component.html',
  styleUrl: './mnofya1.component.css'
})
export class Mnofya1Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
