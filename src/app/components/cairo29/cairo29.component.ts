...
@Component({
  selector: 'app-cairo29',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo29.component.html',
  styleUrl: './cairo29.component.css'
})
export class Cairo29Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
...
export const SERVICES2 = [
  ...
  },
  {
    ...
    route: '/restaurant/Cairo29'
  },
  {
    title: 'سوبر ماركت',
    icon: 'bi bi-basket-fill',
    route: '/market/Cairo29'
  },
];
