...
@Component({
  selector: 'app-cairo31',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo31.component.html',
  styleUrl: './cairo31.component.css'
})
export class Cairo31Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
