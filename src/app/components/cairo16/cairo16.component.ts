...
@Component({
  selector: 'app-cairo16',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo16.component.html',
  styleUrl: './cairo16.component.css'
})
export class Cairo16Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
...
export const SERVICES2 = [
  ...
  },
  {
    ...
    route: '/market/Cairo16'
  },
 {
    title: 'مطاعم',
    icon: 'bi bi-shop-window',
    route: '/restaurant/Cairo16'
  },
];
