...
@Component({
  selector: 'app-cairo38',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo38.component.html',
  styleUrl: './cairo38.component.css'
})
export class Cairo38Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
...
export const SERVICES2 = [
  ...
  },
  {
    ...
    route: '/market/Cairo38'
  },
  {
    title: 'مطاعم',
    icon: 'bi bi-shop-window',
    route: '/restaurant/Cairo38'
  },
];
