...
@Component({
  selector: 'app-matrouh3',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './matrouh3.component.html',
  styleUrl: './matrouh3.component.css'
})
export class Matrouh3Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
