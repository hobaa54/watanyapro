...
@Component({
  selector: 'app-qalyub5',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './qalyub5.component.html',
  styleUrl: './qalyub5.component.css'
})
export class Qalyub5Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
