...
@Component({
  selector: 'app-qalyub4',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './qalyub4.component.html',
  styleUrl: './qalyub4.component.css'
})
export class Qalyub4Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
