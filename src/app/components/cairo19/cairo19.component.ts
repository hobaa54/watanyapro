...
@Component({
  selector: 'app-cairo19',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo19.component.html',
  styleUrl: './cairo19.component.css'
})
export class Cairo19Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
