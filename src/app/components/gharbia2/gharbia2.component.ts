...
@Component({
  selector: 'app-gharbia2',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gharbia2.component.html',
  styleUrl: './gharbia2.component.css'
})
export class Gharbia2Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
