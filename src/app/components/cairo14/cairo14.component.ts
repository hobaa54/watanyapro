...
@Component({
  selector: 'app-cairo14',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './cairo14.component.html',
  styleUrl: './cairo14.component.css'
})
export class Cairo14Component implements AfterViewInit {
  station: any;
  services2 = SERVICES2;
